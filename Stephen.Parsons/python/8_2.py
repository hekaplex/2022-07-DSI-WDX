...
"""
#this code is useful to validate game integrity before it can start
import random

ITEMS_FILENAME = "Chapter_7_Exercises\wizard_all_items.txt"
INVENTORY_FILENAME = "Chapter_7_Exercises\wizard_inventory.txt"
