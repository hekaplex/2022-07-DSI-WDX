...
ITEMS_FILENAME = "G:\DSI-Hekaplex-Clone\\2022-07-DSI-WDX\RGood\Python\wizard_all_items.txt"
INVENTORY_FILENAME = "G:\DSI-Hekaplex-Clone\\2022-07-DSI-WDX\RGood\Python\wizard_inventory.txt"
...
def main():
    ...
    try:
        ...
        print ("get gud at game bruh, get some gear!")
        while True:        
